...
<div class="contenido-modulo">
	...
	<div class="container">
		...
		<input type="hidden" name="post_type" value="categorias">
		<input type="hidden" id="post_status" name="post_status" value="publicado">
	...
	<!------ ORDEN ---------->
				<div class="col-20">
					<div class="form-group">
						<label for="post_orden">Orden </label>
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=categorias" class="btn">Volver a lista</a>
